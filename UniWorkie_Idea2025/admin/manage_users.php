...
$result = $conn->query("SELECT * FROM users WHERE role='buyer'");
?>
<!DOCTYPE html>
<html>
<head>
    <title>Manage Users | PURE BATU PAHAT</title>
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <h1 class="welcome">Manage Users</h1>
        </div>
        ...
        <table>
            ...
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
    <a href="delete_user.php?id=<?= $row['id'] ?>&role=buyer" 
