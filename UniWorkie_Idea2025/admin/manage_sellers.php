...
$result = $conn->query("SELECT * FROM users WHERE role='seller'");
?>
<!DOCTYPE html>
<html>
<head>
    <title>Manage Sellers | PURE BATU PAHAT</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
         <li><a href="dashboard.php"><i class="fas fa-home"></i> Dashboard</a></li>
            ...
            <li><a href="manage_sellers.php"class="active"><i class="fas fa-store"></i> Manage Sellers</a></li>
    ...
    <div class="main-content">
        <div class="header">
            <h1 class="welcome">Manage Sellers</h1>
        </div>
        ...
        <table>
            ...
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                 ...
                 <td>
    <a href="delete_user.php?id=<?= $row['id'] ?>&role=seller" 
